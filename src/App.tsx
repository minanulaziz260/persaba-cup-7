...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-pitch-950 pb-10">
      ...
      <div className="mx-auto max-w-5xl px-5 mt-10 mb-8 flex justify-center">
        <Link 
          to="/gallery" 
          className="inline-flex items-center gap-2 rounded-xl bg-amber-500/10 px-6 py-3 text-sm font-600 text-amber-400 ring-1 ring-inset ring-amber-500/20 hover:bg-amber-500/20 hover:text-amber-300 transition-all active:scale-95"
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
          </svg>
          Lihat Galeri Foto Matchday
        </Link>
      </div>
